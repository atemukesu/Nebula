        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("gui.nebula.config.render_in_game"))
                                .description(OptionDescription
                                        .of(Text.translatable("gui.nebula.config.render_in_game.desc")))
                                .binding(
                                        true,
                                ...
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("gui.nebula.config.show_debug_hud"))
                                .binding(
                                        false,

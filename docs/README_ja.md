...
nbl形式の詳細については、[こちら](/docs/nbl_format_ja.md)をクリックしてください。
...
## 謝辞
* [MadParticle](https://github.com/USS-Shenzhou/MadParticle) 氏に感謝いたします。本プロジェクトは同氏の活動にインスパイアされており、実装の一部を参考にさせていただきました。
